    ...
    <div className='register'>
      <div className='register__container'>
        ...
        <form className='register__form'>
          ...
          <input className='register__input' id='register-name' type='text'></input>
          ...
          <input className='register__input' id='register-email' type='email'></input>
          ...
          <input className='register__input register__input_failed' id='register-password' type='password'></input>
